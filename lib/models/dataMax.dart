...
//
//     final dataMax = dataMaxFromJson(jsonString);

import 'dart:convert';

DataMax dataMaxFromJson(String str) => DataMax.fromJson(json.decode(str));

String dataMaxToJson(DataMax data) => json.encode(data.toJson());
...
class DataMax {
  ...
  factory DataMax.fromJson(Map<String, dynamic> json) => DataMax(
